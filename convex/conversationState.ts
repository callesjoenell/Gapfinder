...
// ============================================================================
// Internal API versions (for actions to call)
// ============================================================================

/**
 * Internal query: Get coverage state for a specific session and phase
 */
export const getCoverageStateInternal = internalQuery({
  args: {
    sessionId: v.id("sessions"),
    phase: v.number(),
  },
...
/**
 * Internal mutation: Add a searched source to the coverage state
 */
export const addSearchedSourceInternal = internalMutation({
  args: {
    sessionId: v.id("sessions"),
    phase: v.number(),
    source: v.string(),
...
/**
 * Internal mutation: Upsert coverage state for a session/phase
 */
export const upsertCoverageStateInternal = internalMutation({
  args: {
    sessionId: v.id("sessions"),
    phase: v.number(),
    topics: v.optional(v.any()),
